# Next Steps for ndx-maze Extension for NWB:N

## Creating Your Extension

1. In a terminal, change directory into the new ndx-maze directory.
...
4. Modify `src/create_extension_spec.py` to define your extension.
    ...
    - If you want to create any custom classes for interacting with the extension,
      ...
      - If present, the `src/pynwb` folder MUST contain the following:
        - `ndx-maze` - Folder with the sources of the NWB extension
        - `ndx-maze/__init__.py` - Python file that may be empty
...
`spec/ndx-maze.namespace.yaml` and
`spec/ndx-maze.extensions.yaml` files.
...
2. Start a git repository for your extension directory ndx-maze
...
`staged-extensions/ndx-maze`.

11. Edit `staged-extensions/ndx-maze/ndx-meta.yaml`
...
12. Edit `staged-extensions/ndx-maze/README.md`
...
ndx-maze-feedstock will be created in the nwb-extensions
GitHub organization and you will be added as a maintainer for that repository.


## Updating Your Published Extension

1. Update your ndx-maze GitHub repository.

2. Publish your updated extension on PyPi.

3. Fork the ndx-maze-feedstock repository on GitHub.

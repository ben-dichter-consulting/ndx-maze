...
# -*- coding: utf-8 -*-
#
# ndx-maze documentation build configuration file, created by
# sphinx-quickstart on Thu Jun 20 17:56:39 2019.
#
...
latex_documents = [
    (master_doc, 'ndx-maze.tex', 'ndx-maze Documentation',
     'Ben Dichter', 'manual'),
]
...
man_pages = [
    (master_doc, 'ndx-maze', 'ndx-maze Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ndx-maze', 'ndx-maze Documentation',
     author, 'ndx-maze', 'One line description of project.',
     'Miscellaneous'),
]
